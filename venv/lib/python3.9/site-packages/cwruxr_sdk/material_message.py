...
class FresnelParameters(Parameters):
    """
    Extension to parameters to handle fresnel materials.
    """
    def __init__(
        self,
        rimWidth : Optional[float]
    ):
        """
        Initialization function.

        Arguments:
        rimWidth -- The thickness of the rim light. Between 0 and 2.
        """
        if rimWidth != None:
...
class FresnelMaterialMessage(MaterialMessage):
    """
    Extension to MaterialMessage to create Fresnel Materials.
    """
    def __init__(
        self,
        id : Optional[str],
        color : Optional[Color],
        parameters : FresnelParameters,
        render_settings : Optional[MaterialRenderSettings] = None
    ):
        """
        Initialization function.
        ...
        id -- The name of the material.
        color -- The base color to use for the material.
        parameters -- The Fresnel parameters to use for the material.
        render_settings -- The render settings to use for the material.      
        """
        super().__init__(
            id,
