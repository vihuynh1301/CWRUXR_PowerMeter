...
class ObjectMessage:
    ...
    def __init__(
            ...
            isColliderOn : Optional[bool] = None,
        ...
        if isColliderOn != None:
            self.isColliderOn = isColliderOn
...
class FileParameters(Parameters):
    """
    An extension to Parameters to use with File object types.
    """
    def __init__(
            self,
            bypassCache : bool,
        ...
        Arguments:
        bypassCache -- Whether or not to load this object from the device cache
        """
...
class LineBundleParameters(Parameters):
    """
    A parameter class to be used for VTK Line Bundle object types.
    """
    def __init__(
            self,
            bypassCache : Optional[bool] = None,
            takeEveryNthLine : Optional[int] = None,
            takeEveryNthPointOfALine : Optional[int] = None,
            color : Optional[Color] = None,
            width : Optional[float] = None,
            deactivatedLineIndexes : Optional[str] = None
        ):
        """
        Initialization function.
        
        Arguments:
        bypassCache -- Whether or not to use cached instance of the file.
        takeEveryNthLine -- How much to downsample by by removing lines.
        takeEveryNthPointOfALine -- How much to downsample by removing points within a line.
        color -- The color of the lines.
        width -- The width of the lines.
        deactivatedLineIndexes -- Comma seperated list of line indexes to turn off.
        """
        if bypassCache != None:
            self.bypassCache = bypassCache
        if takeEveryNthLine != None:
            self.takeEveryNthLine = takeEveryNthLine
        if takeEveryNthPointOfALine != None:
            self.takeEveryNthPointOfALine = takeEveryNthPointOfALine
        if color != None:
            self.color = color
        if width != None:
            self.width = width
        if deactivatedLineIndexes != None:
            self.deactivatedLineIndexes = deactivatedLineIndexes
...
class TextMessage(ObjectMessage):
    ...
    def __init__(
            ...
            pose : Optional[Pose] = None, 
            active : Optional[bool] = None,
            parameters : Optional[TextParameters] = None,
            isManipulationOn : Optional[bool] = None,
            isColliderOn : Optional[bool] = None,
            interpolation : Optional[Interpolation] = None,
        ):
        ...
        pose -- The pose to display this object with.
        active -- The pose of this object. Contains the position, rotation, and scale.
        parameters -- Parameters to use for rendering the text for this object.
        isManipulationOn -- Whether or not this object is grabbable and movable.
        interpolation -- The interpolation settings to use for this object.
        """
        super().__init__(
...
class LineMessage(ObjectMessage):
    ...
    def __init__(
            ...
            parentID : Optional[str] = None,
            active : Optional[bool] = None,
            parameters : Optional[LineParameters] = None,
            interpolation : Optional[Interpolation] = None,
        ):
        """
        Initialization function.
        ...
        parentID -- The name of the object to parent this object to.
        active -- The pose of this object. Contains the position, rotation, and scale.
        parameters -- Parameters to use for rendering the line for this object.
        interpolation -- The interpolation settings to use for this object.
        """
        super().__init__(
                id = id,
...
class FileMessage(ObjectMessage):
    ...
    def __init__(
            ...
            materialID : Optional[str] = None,
            active : Optional[bool] = None,
            parameters : Optional[FileParameters] = None,
            isManipulationOn : Optional[bool] = None,
            walkable : Optional[bool] = None,
            isColliderOn : Optional[bool] = None,
            interpolation : Optional[Interpolation] = None,
...
class ImageMessage(ObjectMessage):
    ...
    def __init__(
        ...
        materialID -- The material to use with this object. Will override the default material, and if it has a texture it will also override the texture.
        active -- The pose of this object. Contains the position, rotation, and scale.
        parameters -- The image parameters to use for rendering this object.
        isManipulationOn -- Whether or not this object is grabbable and movable.
        interpolation -- The interpolation settings to use for this object.
        """
        super().__init__(
...
class LineBundleMessage(ObjectMessage):
    def __init__(
            self,
            id : Optional[str] = None,
            parentID : Optional[str] = None,
            ...
            pose : Optional[Pose] = None,
            active : Optional[bool] = None,
            parameters : Optional[LineBundleParameters] = None,
            isManipulationOn : Optional[bool] = None,
            isColliderOn : Optional[bool] = None,
            interpolation : Optional[Interpolation] = None,
        ):
        ...
        pose -- The pose to display this object with.
        active -- The pose of this object. Contains the position, rotation, and scale.
        parameters -- The line bundle parameters to use for rendering this object.
        isManipulationOn -- Whether or not this object is grabbable and movable.
        interpolation -- The interpolation settings to use for this object.
        """
        super().__init__(
